...
After that - if more than 1 group is created - injector generates simultaneous copy statements for the groups by utilizing \texttt{std::thread} and \texttt{labmda} expressions.
