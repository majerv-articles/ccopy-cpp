...
These prerequisites can be easily checked with methods provided on \texttt{CXXRecordDecl}, even for c) we only need an other record declaration for our \texttt{C4} marker "interface".
